	           ...
	           <div class="col-md-2"></div>
                <div class="col-md-8 ">
                    <div class="panel panel-info">
                        <div class="panel-heading"><h3 class="panel-title text-white">Advanced Salary Provide
                            <a href="{{ route('all.advance_salary') }}" class="btn btn-sm btn-danger pull-right">All Advanced Salary</a>
                        </h3>
                        </div>
                        ...
                        <div class="panel-body">
                            <form role="form" action="{{ url('/insert-advancedsalary') }}" method="post">
                            	{{csrf_field()}}
